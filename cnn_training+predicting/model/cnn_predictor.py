...
#         channel = 64
#         k = 1
#         layers = [nn.Conv2d(channel, channel*k, 3, 1, 1)]
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         self.conv1_0 = nn.Sequential(*layers)
#
#         layers = [nn.Conv2d(channel, channel*k, 5, 1, 2)]
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
...
#
#         layers = [nn.Conv2d(channel, channel*k, 7, 1, 3)]
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
...
#
#         layers = [nn.Conv2d(channel*k, channel*k, 3, 1, 1)]
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
...
#         layers.append(nn.Conv2d(channel*k, channel*k, 3, 1, 1))
#         layers.append(nn.Tanh())
#         layers.append(nn.Conv2d(channel*k, channel, 3, 1, 1))
...
class CNNP(nn.Module): # CNN预测器
    def __init__(self):
        ...
        layers = [nn.Conv2d(channel, channel, 5, 1, 2)]
        layers.append(nn.LeakyReLU(inplace=True))
        layers.append(nn.Conv2d(channel, channel, 3, 1, 1))
        layers.append(nn.LeakyReLU(inplace=True))
        layers.append(nn.Conv2d(channel, channel, 3, 1, 1))
        ...
        layers = [nn.Conv2d(channel, channel, 7, 1, 3)]
        layers.append(nn.LeakyReLU(inplace=True))
        layers.append(nn.Conv2d(channel, channel, 3, 1, 1))
        layers.append(nn.LeakyReLU(inplace=True))
        layers.append(nn.Conv2d(channel, channel, 3, 1, 1))
